...
The scenarios cover Predict composition and precedence, event filtering, dynamic-expression failure, two-turn CodeAct with changing dynamic state, and context-budget eviction. New skill-view and custom-view behavior is excluded because it has no legacy equivalent.
