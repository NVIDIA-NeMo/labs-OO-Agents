...
[License](https://github.com/NVIDIA-NeMo/labs-OO-Agents/blob/main/LICENSE)
...
For setup details and more details on how to run local models, see [Running NOOA With Local Models](docs/local-models.md).
