...
The stack is `main` → benchmark prerequisites (#331) → shared agent/ACP (#330)
→ AionUi experiment (#346) → native TUI (`dev/tui`). Run both clients from the final TUI checkout so they
