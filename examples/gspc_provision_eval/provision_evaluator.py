...
Demonstrates the pattern Council of AI contributes to this repo's
evaluations-and-benchmarks examples:
...
# (estate corpus is out of scope for this example); see README.md. Each provision carries the literal keyword
