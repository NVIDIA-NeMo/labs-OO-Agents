...
async def main():
    ...
    print("  - agent_call middleware pushed a ScopeType.Function scope per traced")
    print("      async method (sync, unwrapped @no_trace, static, and class methods")
    print("      are not wrapped)")
