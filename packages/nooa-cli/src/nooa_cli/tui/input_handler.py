    ...
    return Style.from_dict(
        {
            ...
            "resume-picker.current": COLORS["blue"],
            "resume-picker.attached": COLORS["peach"],
            "resume-picker.match": f"{COLORS['yellow']} bold underline",
            "resume-picker.meta": COLORS["subtext0"],
            "resume-picker.detail": COLORS["subtext1"],
            "resume-picker.search-label": f"{COLORS['lavender']} bold",
            "resume-picker.control": COLORS["subtext1"],
            ...
            "resume-picker.preview-user": f"{COLORS['blue']} bold",
            "resume-picker.preview-agent": f"{COLORS['green']} bold",
            "resume-picker.footer": COLORS["subtext0"],
            "resume-picker.empty": f"{COLORS['subtext0']} italic",
            "resume-picker.too-small": f"{COLORS['yellow']} bold",
            "resume-picker.muted": COLORS["overlay1"],
            # Completion menu
