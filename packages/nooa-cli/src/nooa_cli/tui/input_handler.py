    ...
    return Style.from_dict(
        {
            ...
            "fullscreen-browser.title": f"{COLORS['text']} bold",
            "fullscreen-browser.row": COLORS["text"],
            "fullscreen-browser.selected": f"bg:{COLORS['surface2']} {COLORS['text']}",
            ...
            "fullscreen-browser.meta": COLORS["subtext0"],
            "fullscreen-browser.detail": COLORS["subtext1"],
            "fullscreen-browser.search-label": f"{COLORS['lavender']} bold",
            "fullscreen-browser.control": COLORS["subtext1"],
            ...
            "fullscreen-browser.control-focused": f"bg:{COLORS['surface2']} {COLORS['lavender']} bold",
            "fullscreen-browser.heading": f"{COLORS['subtext1']} bold",
            ...
            "fullscreen-browser.preview": COLORS["subtext0"],
            "fullscreen-browser.preview-user": f"bg:{COLORS['surface2']} {COLORS['text']}",
            "fullscreen-browser.preview-user-edge": COLORS["surface2"],
            "fullscreen-browser.preview-agent": f"{COLORS['overlay1']} bold",
            "fullscreen-browser.footer": COLORS["subtext0"],
            "fullscreen-browser.empty": f"{COLORS['subtext0']} italic",
            "fullscreen-browser.too-small": f"{COLORS['yellow']} bold",
            "fullscreen-browser.muted": COLORS["overlay1"],
            # Completion menu
