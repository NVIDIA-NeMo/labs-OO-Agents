...
_SKIP_FIELDS = {"tui.skills_dirs", "tui.agent_spec", "no_splash", "no_trace", "legacy_agent"}
...
def remove_project_mcp_server(name: str) -> tuple[Path, bool]:
    """Remove a server from both project settings spellings, preserving siblings.

    Native /mcp add rollback and /mcp remove edit only the writable project
    layer; external MCP files and inherited user settings remain untouched.
    """
    import yaml
