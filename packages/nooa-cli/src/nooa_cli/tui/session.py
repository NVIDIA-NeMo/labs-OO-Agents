...
class Session:
    ...
    def _restart_idle(self) -> bool:
        ...
        Keep the UI and command readiness checks consistent across probes.
        """
        command_runner = self._command_runner
        return self._app.input_drain_idle and (command_runner is None or command_runner.is_idle)
    ...
    async def wait_restart_ready(self) -> None:
        ...
        producers: a turn admitted before the request can still spawn fresh
        infrastructure after the early cancellation passes have run.
        """
