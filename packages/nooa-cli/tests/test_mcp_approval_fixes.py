...
import pytest
from nooa_cli.interactive.mcp_approval import MCPApprovalStore, build_approval_request
...
def test_approval_store_write_failure_does_not_double_close_fd(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("nooa_cli.interactive.mcp_approval.os.close", tracking_close)
    monkeypatch.setattr(
        "nooa_cli.interactive.mcp_approval.os.replace",
